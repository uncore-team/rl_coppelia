...
from gui import dialogs, robot_generator
...
class WelcomeScreen(QWidget):
    ...
    def init_ui(self):
        ...
        # Left side: logo
        logo_label = QLabel()
        logo_path = pkg_resources.resource_filename("gui", "assets/uncore.png")
...
class MainApp(QMainWindow):
    def __init__(self):
        ...
        self.plot_tooltip_label.setText(dialogs.PLOT_TOOLTIPS)
    ...
    def load_main_interface(self):
        ...
        # Botón Refresh
        refresh_icon_path = pkg_resources.resource_filename("gui", "assets/refresh_icon.png")
    ...
    def update_train_scene_path_from_robot(self):
        ...
        if self.train_robot_name_combo.currentText() == "Create a new one!":
            ...
            refresh_lists(self.train_robot_name_combo, category="robot")
    ...
    def create_train_tab(self):
        ...
        self.edit_params_button.setIcon(QIcon(pkg_resources.resource_filename("gui", "assets/gear_icon.png")))
    ...
    def handle_scene_folder_change(self, folder_name):
        ...
        if folder_name == "Custom your scene":
            ...
            if dialog.exec_() == QDialog.Accepted:
                ...
                refresh_lists(self.test_scene_scene_to_load_folder_input, "scene_configs")
    ...
    def create_test_scene_tab(self):
        ...
        refresh_lists(self.test_scene_robot_name_input, category="robot")
        ...
        self.test_scene_edit_scene_button.setIcon(QIcon(pkg_resources.resource_filename("gui", "assets/edit_icon.png")))
        ...
        self.test_scene_delete_scene_button.setIcon(QIcon(pkg_resources.resource_filename("gui", "assets/delete_icon.png")))
    ...
    def create_plot_tab(self):
        ...
        refresh_lists(self.plot_robot_name_input, "robot")
    ...
    def create_auto_training_tab(self):
        ...
        refresh_lists(self.auto_train_robot_name_input, category="robot")
